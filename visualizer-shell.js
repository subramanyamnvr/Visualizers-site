...
function getWorkbenchConfig(){if(/data-engineering\/field-atlas\//i.test(locationPath)){return{mountSelector:"main",title:"Data Engineering Atlas",copy:"Open one chapter at a time instead of scanning the whole field in one long scroll.",maxWidth:"1080px",pages:[{id:"workbench",label:"Workbench",group:"Overview",selectors:["section#workbench"]},{id:"home",label:"Home",group:"Overview",selectors:[".hero"]}],autoSelector:"section.section-card[id][data-nav]",autoGroup:"Topics"};}
